...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-west-2:571773500112:cluster:my-aurora-serverless"
  aurora_db_name    = "myapp"
  aurora_endpoint   = "my-aurora-serverless.cluster-cbea68cygijd.us-west-2.rds.amazonaws.com"
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-west-2:571773500112:secret:my-aurora-serverless-bsXGU4"
  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-571773500112-0e85a5f0"
}